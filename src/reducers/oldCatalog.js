import {UPDATE_CATALOG_ITEM, SEARCH_CATALOG_ITEM, SET_CATALOG_STATE, SET_CATALOG_ITEM, SET_CATALOG_EAN } from '../actions/oldCatalog';
import {IDLE, SEARCH, FAIL, ABORT, INCOMPLETE, OK } from '../actions/oldCatalog';
